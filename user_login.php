...
<head>
    ...
    <title>Login User | Radio Republik Indonesia</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>ARSIP DIGITAL</h3>
                <h4>Radio Republik Indonesia</h4>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Radio Republik Indonesia</p>
            </div>
        </div>   
    </div>
